...
import { UserExperience, getUserExperienceLabel } from '@/types/UserExperience';
            ...
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    ...
                    >
                        ...
                        <option :value="UserExperience.JUNIOR">
                            {{ getUserExperienceLabel(UserExperience.JUNIOR) }}
                        </option>
                        <option :value="UserExperience.MIDDLE">
                            {{ getUserExperienceLabel(UserExperience.MIDDLE) }}
                        </option>
                        <option :value="UserExperience.SENIOR">
                            {{ getUserExperienceLabel(UserExperience.SENIOR) }}
                        </option>
                    </select>
